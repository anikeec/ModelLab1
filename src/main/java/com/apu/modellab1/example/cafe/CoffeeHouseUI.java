...
//		this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			gridBagConstraints6.insets = new Insets(4, 40, 3, 29);
			
			GridBagConstraints gridBagConstraints5 = new GridBagConstraints();
			gridBagConstraints5.insets = new Insets(4, 5, 4, 5);
			...
			gridBagConstraints3.insets = new Insets(6, 3, 4, 14);
			gridBagConstraints3.gridy = 0;
			gridBagConstraints3.ipadx = 8;
			gridBagConstraints3.ipady = -41;
			gridBagConstraints3.gridx = 1;
			GridBagConstraints gridBagConstraints2 = new GridBagConstraints();
			gridBagConstraints2.insets = new Insets(6, 6, 4, 2);
