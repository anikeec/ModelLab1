...
public class ShansUI extends JFrame implements IShansVisualPart {
	...
	private Diagram getDiagram() {
		if (diagram == null) {
			...
			diagram.setTitleText("Распределение величины дохода");
		}
		return diagram;
	}
	...
	private JTextField getJTextFieldPriz() {
		if (jTextFieldPriz == null) {
			...
			jTextFieldPriz.setBounds(new java.awt.Rectangle(361, 211, 162, 45));
	...
	private JTextField getJTextFieldN() {
		if (jTextFieldN == null) {
			...
			jTextFieldN.setBounds(new java.awt.Rectangle(364,272,162,45));
	...
	private JCheckBox getJCheckBox() {
		if (jCheckBox == null) {
			...
			jCheckBox.setText("Протокол работы на консоль");
