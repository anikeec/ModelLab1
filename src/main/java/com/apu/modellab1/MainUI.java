...
import com.apu.modellab1.buldo2018.BuldGUI;
import com.apu.modellab1.example.cafe.CoffeeHouseUI;
import com.apu.modellab1.example.disco.DiscoGuiNew;
import com.apu.modellab1.example.market.MarketGUI;
...
public class MainUI extends JFrame {
		...
		if (jButton51 == null) {
			...
			jButton51.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					com.apu.modellab1.toLab5_testTheory.TheoryGUI app = 
                                                new com.apu.modellab1.toLab5_testTheory.TheoryGUI();
	...
	private JButton getJButton1() {
		if (jButton1 == null) {
			...
			jButton1.setBorder(BorderFactory.createMatteBorder(5, 5, 5, 5,
					Color.white));
			jButton1.setText("Спогади про  теорію ймовірностей");
	...
	private JButton getJButton13() {
		if (jButton61 == null) {
			...
			jButton61.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					getJDialog6().setVisible(false);
					com.apu.modellab1.toLab6_testFactorExperiment.FactorGUI app = 
                                                new com.apu.modellab1.toLab6_testFactorExperiment.FactorGUI();
					app.setLocationRelativeTo(MainUI.this);
					app.setVisible(true);
				}
			});
	...
	private JButton getJButton2() {
		if (jButton2 == null) {
			...
			jButton2
					.setText("Генератори випадкових чисел");
	...
	private JButton getJButton3() {
		if (jButton3 == null) {
			...
			jButton3
					.setText("Побудова імітаційних моделей систем масового обслуговування");
	...
	private JButton getJButton4() {
		if (jButton4 == null) {
			...
			jButton4
					.setText("Засоби імітаційного моделювання паралельних процесів");
	...
	private JButton getJButton5() {
		if (jButton5 == null) {
			...
			jButton5
					.setText("Аналітичне та експериментальне дослідження найпростішої СМО");
			...
			jButton521.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					SwingUtilities.invokeLater(new Runnable() {
						public void run() {
							MainForTests.runTestToLabNumber(5);
...
//							application.getJFrame().setVisible(true);
	...
	private JButton getJButton6() {
		if (jButton6 == null) {
			...
			jButton6.setText("Однофакторні багаторівневі експерименти з моделями");
		...
		if (jButton621 == null) {
			...
			jButton621.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					SwingUtilities.invokeLater(new Runnable() {
						public void run() {
							MainForTests.runTestToLabNumber(6);
//							MainTest application = (MainTest) MainTest
//									.getTestForLab6();
//							application.getJFrame().setLocationRelativeTo(MainUI.this);
...
//							application.getJFrame().setVisible(true);
	...
	private JButton getJButton7() {
		if (jButton7 == null) {
			...
			jButton7
					.setText("Перехідні процеси у системах масового обслуговування");
		...
		if (jButton77 == null) {
			...
			jButton77.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					SwingUtilities.invokeLater(new Runnable() {
						public void run() {
							MainForTests.runTestToLabNumber(7);
//						}
//							MainTest application = (MainTest) MainTest
//									.getTestForLab7();
//							application.getJFrame().setLocationRelativeTo(MainUI.this);
	...
	private JButton getJButton92() {
		if (jButton92 == null) {
			...
			jButton92.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					getJDialog9().setVisible(false);
					new com.apu.modellab1.example.swich.SwitchUI().setVisible(true);
				}
			});
		}
		return jButton92;
	...
	private JButton getJButton93() {
		if (jButton93 == null) {
			...
			jButton93.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					getJDialog9().setVisible(false);
					new com.apu.modellab1.example.shans.ShansUI().setVisible(true);
				}
			});
		}
		return jButton93;
	...
	private JButton getJButton94() {
		if (jButton94 == null) {
			...
			jButton94.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					getJDialog9().setVisible(false);
					new com.apu.modellab1.example.competition.VisualPart().setVisible(true);
		...
		if (jButtonD05 == null) {
			...
			jButtonD05.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					SwingUtilities.invokeLater(new Runnable() {
						public void run() {
							MainForTests.runTestToLabNumber(1);
//							MainTest application = (MainTest) MainTest
//									.getTestForLab1();
//							application.getJFrame().setLocationRelativeTo(MainUI.this);
		...
		if (jButtonD2Test == null) {
			...
			jButtonD2Test.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					SwingUtilities.invokeLater(new Runnable() {
						public void run() {
							MainForTests.runTestToLabNumber(2);
//							MainTest application = (MainTest) MainTest
//									.getTestForLab2();
//							application.getJFrame().setLocationRelativeTo(MainUI.this);
		...
		if (jButtonD37 == null) {
			...
			jButtonD37.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					SwingUtilities.invokeLater(new Runnable() {
						public void run() {
							MainForTests.runTestToLabNumber(4);
//							MainTest application = (MainTest) MainTest
//									.getTestForLab4();
//							application.getJFrame().setLocationRelativeTo(MainUI.this);
	...
	private JButton getJButtonD3rgr() {
		if (jButtonD3rgr == null) {
			...
			jButtonD3rgr.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					getJDialog3().setVisible(false);
					com.apu.modellab1.buldo2018.BuldGUI app = new com.apu.modellab1.buldo2018.BuldGUI();
					app.setLocationRelativeTo(MainUI.this);
					app.setVisible(true);
		...
		if (jButtonD3Test == null) {
			...
			jButtonD3Test.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					SwingUtilities.invokeLater(new Runnable() {
						public void run() {
							MainForTests.runTestToLabNumber(3);
//							MainTest application = (MainTest) MainTest
//									.getTestForLab3();
//							application.getJFrame().setLocationRelativeTo(MainUI.this);
		...
		if (jButtonItogTest == null) {
			...
			jButtonItogTest.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					SwingUtilities.invokeLater(new Runnable() {
						public void run() {
							MainForTests.runTestToLabNumber(8);
//							MainTest application = (MainTest) MainTest
//									.getTestForAllLab();
//							application.getJFrame().setLocationRelativeTo(MainUI.this);
...
//							application.getJFrame().setVisible(true);
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jLabel.setText("Чернігівський державний технологічний університет");
