...
public class DelayObjectView extends javax.swing.JPanel implements
	...
	private DelayObject getDelayObject() {
		if (ivjDelayObject == null) {
			try {
				ivjDelayObject = new com.apu.modellab1.toLab8_testGradient.DelayObject();
				// user code begin {1}
				// user code end
	...
	private javax.swing.JLabel getJLabel1() {
		if (ivjJLabel1 == null) {
			try {
				...
				ivjJLabel1.setText("ОБЪЕКТ УПРАВЛЕНИЯ");
				ivjJLabel1
	...
	private javax.swing.JLabel getJLabel11() {
		if (ivjJLabel11 == null) {
			try {
				...
				ivjJLabel11.setText("Возм. воздействие");
				// user code begin {1}
				// user code end
			} catch (java.lang.Throwable ivjExc) {
				// user code begin {2}
	...
	private javax.swing.JLabel getJLabel111() {
		if (ivjJLabel111 == null) {
			try {
				...
				ivjJLabel111.setText("Начальное  состояние");
				// user code begin {1}
				// user code end
			} catch (java.lang.Throwable ivjExc) {
				// user code begin {2}
	...
	private javax.swing.JLabel getJLabel21() {
		if (ivjJLabel21 == null) {
			try {
				...
				ivjJLabel21.setText("Параметры обьекта");
				ivjJLabel21
						.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
				// user code begin {1}
				// user code end
	...
	private javax.swing.JLabel getJLabel311() {
		if (ivjJLabel311 == null) {
			try {
				...
				ivjJLabel311.setText("Постоянная времени");
				// user code begin {1}
				// user code end
			} catch (java.lang.Throwable ivjExc) {
				// user code begin {2}
	...
	private javax.swing.JLabel getJLabel321() {
		if (ivjJLabel321 == null) {
			try {
				...
				ivjJLabel321.setText("Запаздывание");
				// user code begin {1}
				// user code end
			} catch (java.lang.Throwable ivjExc) {
				// user code begin {2}
	...
	private javax.swing.JLabel getJLabel33() {
		if (ivjJLabel33 == null) {
			try {
				...
				ivjJLabel33.setText("Коэфф. усиления");
				// user code begin {1}
				// user code end
			} catch (java.lang.Throwable ivjExc) {
				// user code begin {2}
	...
	private void initialize() {
		try {
			...
			constraintsJLabel11.ipadx = 24;
			constraintsJLabel11.insets = new java.awt.Insets(4, 8, 3, 0);
			...
			constraintsJLabel21.ipadx = 12;
			constraintsJLabel21.insets = new java.awt.Insets(2, 24, 2, 28);
			...
			constraintsJLabel33.ipadx = 34;
			constraintsJLabel33.insets = new java.awt.Insets(4, 8, 4, 0);
			...
			constraintsJLabel311.ipadx = 9;
			constraintsJLabel311.insets = new java.awt.Insets(4, 8, 4, 0);
			...
			constraintsJLabel321.ipadx = 47;
			constraintsJLabel321.insets = new java.awt.Insets(4, 8, 6, 0);
			...
			constraintsJLabel1.ipadx = 29;
			constraintsJLabel1.insets = new java.awt.Insets(7, 10, 2, 11);
			...
			constraintsJLabel111.ipadx = 2;
			constraintsJLabel111.insets = new java.awt.Insets(4, 8, 3, 0);
