...
public class PidControllerView extends javax.swing.JPanel implements
	...
	private javax.swing.JLabel getJLabel11() {
		if (ivjJLabel11 == null) {
			try {
				...
				ivjJLabel11.setText("Нач. знач. выхода");
				// user code begin {1}
				// user code end
			} catch (java.lang.Throwable ivjExc) {
				// user code begin {2}
	...
	private javax.swing.JLabel getJLabel2() {
		if (ivjJLabel2 == null) {
			try {
				...
				ivjJLabel2.setText("Настройка воздействий");
				ivjJLabel2
	...
	private javax.swing.JLabel getJLabel3() {
		if (ivjJLabel3 == null) {
			try {
				...
				ivjJLabel3.setText("Пропорциональное");
				// user code begin {1}
				// user code end
			} catch (java.lang.Throwable ivjExc) {
				// user code begin {2}
	...
	private javax.swing.JLabel getJLabel31() {
		if (ivjJLabel31 == null) {
			try {
				...
				ivjJLabel31.setText("Интегральное");
				// user code begin {1}
				// user code end
			} catch (java.lang.Throwable ivjExc) {
				// user code begin {2}
	...
	private javax.swing.JLabel getJLabel32() {
		if (ivjJLabel32 == null) {
			try {
				...
				ivjJLabel32.setText("Дифференциальное");
				// user code begin {1}
				// user code end
			} catch (java.lang.Throwable ivjExc) {
				// user code begin {2}
	...
	private javax.swing.JLabel getJLabel4() {
		if (ivjJLabel4 == null) {
			try {
				...
				ivjJLabel4.setText("ПИД-РЕГУЛЯТОР");
				ivjJLabel4
						.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
				// user code begin {1}
				// user code end
	...
	private PidController getPidController() {
		if (ivjPidController == null) {
			try {
				ivjPidController = new com.apu.modellab1.toLab8_testGradient.PidController();
				// user code begin {1}
				// user code end
			} catch (java.lang.Throwable ivjExc) {
				// user code begin {2}
	...
	private void initialize() {
		try {
			...
			constraintsJLabel2.ipadx = 25;
			constraintsJLabel2.insets = new java.awt.Insets(1, 8, 0, 8);
			add(getJLabel2(), constraintsJLabel2);

			java.awt.GridBagConstraints constraintsJLabel1 = new java.awt.GridBagConstraints();
			constraintsJLabel1.gridx = 1;
			constraintsJLabel1.gridy = 2;
			constraintsJLabel1.ipadx = 8;
			constraintsJLabel1.insets = new java.awt.Insets(3, 7, 4, 72);
			add(getJLabel1(), constraintsJLabel1);

			java.awt.GridBagConstraints constraintsJLabel3 = new java.awt.GridBagConstraints();
			constraintsJLabel3.gridx = 1;
			constraintsJLabel3.gridy = 5;
			constraintsJLabel3.ipadx = 4;
			constraintsJLabel3.insets = new java.awt.Insets(2, 7, 4, 11);
			...
			constraintsJLabel31.ipadx = 38;
			constraintsJLabel31.insets = new java.awt.Insets(5, 7, 4, 10);
			...
			constraintsJLabel32.ipadx = 10;
			constraintsJLabel32.insets = new java.awt.Insets(5, 7, 9, 2);
			...
			constraintsJLabel4.ipadx = 50;
			constraintsJLabel4.insets = new java.awt.Insets(9, 15, 0, 16);
			...
			constraintsJLabel11.ipadx = 20;
			constraintsJLabel11.insets = new java.awt.Insets(5, 7, 3, 8);
